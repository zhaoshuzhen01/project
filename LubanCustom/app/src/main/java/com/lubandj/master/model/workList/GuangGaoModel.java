...
public class GuangGaoModel {
    ...
    public GuangGaoModel(Context context,DataCall dataCall){
    ...
    public void getGuangGao() {
        ...
        TaskEngine.getInstance().tokenHttps(Canstance.HTTP_GUANGAO_LIST,null, new Response.Listener<String>() {

            @Override
            public void onResponse(String s) {

                GuangGaoBeen msgCenterBeen = new Gson().fromJson(s, GuangGaoBeen.class);
