...
public class HomeListAdapter extends BaseQuickAdapter<MsgCenterBeen.InfoBean.ListBean, BaseViewHolder> {
    private Context context;
    public HomeListAdapter(@Nullable List<MsgCenterBeen.InfoBean.ListBean> data, Context context) {
