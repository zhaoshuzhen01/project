...
/**
 * Created by ${zhaoshuzhen} on 2018/5/14.
 */

public class DetailPingjiaInitModel {
    private Context context ;
    private DataCall dataCall ;
    public DetailPingjiaInitModel(Context context,DataCall dataCall){
        this.context = context ;
        this.dataCall = dataCall ;
    }

    public void getPingJiaData(String id) {

        TaskEngine.getInstance().tokenHttps(Canstance.HTTP_DETAIL_PINGJIA_INIT_LIST,id, new Response.Listener<String>() {
