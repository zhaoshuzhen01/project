...
package com.example.baselibrary.wheel.kankan.wheel.widget;
...
import com.example.baselibrary.wheel.kankan.wheel.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] { 0xFF,
			0xFF, 0xFF };
	...
	private int getDesiredHeight(LinearLayout layout) {
		...
		int desired = itemHeight * visibleItems - itemHeight * ITEM_OFFSET_PERCENT /45;
