...
public class RetrofitClient <T> {
   ...
   /**
    ...
    public Subscription getData(Subscriber<T> subscriber, String ip) {
    ...
    public Subscription get(String url, Map parameters, Subscriber<T> subscriber) {
    ...
    public Subscription json(String url, RequestBody jsonStr, Subscriber<T> subscriber) {
