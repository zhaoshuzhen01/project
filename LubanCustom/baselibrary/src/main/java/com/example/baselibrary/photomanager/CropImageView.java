 ...
 * @Description: TODO(图片剪裁容器)
 * @date 2016-5-14 下午2:10:11
 */
public class CropImageView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.clipRect(mDrawableFloat, Op.DIFFERENCE);
        // 在交集的补集上画上灰色用来区分
    ...
    public Bitmap getCropImage() {
        ...
        int w = tmpBitmap.getWidth() >mDrawableFloat.width() ?mDrawableFloat.width():tmpBitmap.getWidth();
        int h = tmpBitmap.getHeight()>mDrawableFloat.height()?mDrawableFloat.height():tmpBitmap.getHeight();

        Bitmap ret = Bitmap.createBitmap(tmpBitmap, mDrawableFloat.left, mDrawableFloat.top, w,h, matrix, true);
        tmpBitmap.recycle();
        tmpBitmap = null;
