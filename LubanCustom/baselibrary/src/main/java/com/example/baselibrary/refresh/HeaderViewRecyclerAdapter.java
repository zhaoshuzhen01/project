...
/**
 * FileName: HeaderAndFooterRecyclerViewAdapter
 * description: 设置recyclerview 头部和底部
 * Author: 丁博洋
 * Date: 2016/8/18
 */
public class HeaderViewRecyclerAdapter extends RecyclerView.Adapter {
    ...
    public View getFooterView() {
        return getFootersCount() > 0 ? mFooterViewInfoList.get(0).view : null;
    }
    ...
    public View getHeaderView() {
        return getHeadersCount() > 0 ? mHeaderViewInfoList.get(0).view : null;
    }
