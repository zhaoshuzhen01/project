...
public class LineFadeIndicator implements AnimatedIndicatorInterface, ValueAnimator.AnimatorUpdateListener {
    ...
    public LineFadeIndicator(CustomTabLayout customTabLayout) {
        ...
        startXLeft = (int) customTabLayout.getChildXLeft(customTabLayout.getCurrentPosition());
        startXRight = (int) customTabLayout.getChildXRight(customTabLayout.getCurrentPosition());
